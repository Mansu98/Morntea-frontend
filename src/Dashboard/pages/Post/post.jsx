...
export default function post() {
  ...
  <div className="container px-5 py-15 mx-auto flex flex-col"> 
    ...
    <h2 className="sm:text-2xl text-2xl font-medium title-font mb-4 mt-4 text-gray-800 text-justify">Annual and Quarterly reports, and analysis
   and provides portfolio management tools.<br/>
   <span class="mt-1 text-gray-500 text-sm">12 Jun 2019</span>
      ...
      <p className="leading-relaxed text-lg mb-4 mt-4">Morntea.com provides live stock quotes, News, announcements,
           ...
           We realize that, for us to prosper, we need to be flexible and responsive, to delight clients by providing them
            with what they want, when they want it, and before the competition can offer it.
            </p>
    </div>
  </div>
</section>
